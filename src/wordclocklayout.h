...
extern void draw_STUNDE(uint16_t color, stateType_t *state);
extern void draw_STUNDEN(uint16_t color, stateType_t *state);
extern void draw_ZU(uint16_t color, stateType_t *state);
...
extern void draw_NOCH(uint16_t color, stateType_t *state);
